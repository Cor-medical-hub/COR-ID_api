...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "APPROVED", "REJECTED", "TIMEOUT", name="authsessionstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_cor_id_auth_sessions_token",
        "cor_id_auth_sessions",
        ["session_token"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cor_id_auth_sessions_cor_id"),
        "cor_id_auth_sessions",
        ["cor_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cor_id_auth_sessions_email"),
        "cor_id_auth_sessions",
        ["email"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cor_id_auth_sessions_session_token"),
        "cor_id_auth_sessions",
        ["session_token"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["serial_number"],
            ["manufactured_devices.serial_number"],
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.cor_id"],
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column(
            "case_id", sa.String(), nullable=False, comment="ID связанного кейса"
        ),
        ...
        sa.Column(
            ...
            sa.DateTime(),
            nullable=True,
            comment="Дата создания направления",
        ),
        sa.Column(
            "research_type",
            sa.Enum(
            ...
            nullable=True,
            comment="Вид исследования",
        ),
        sa.Column(
            "container_count",
            sa.Integer(),
            nullable=True,
            comment="Фактическое количество контейнеров",
        ),
        sa.Column(
            "medical_card_number", sa.String(), nullable=True, comment="Номер медкарты"
        ),
        sa.Column(
            "clinical_data", sa.Text(), nullable=True, comment="Клинические данные"
        ),
        sa.Column(
            "clinical_diagnosis",
            sa.String(),
        ...
        sa.Column(
            ...
            sa.String(),
            nullable=True,
            comment="Медицинское учреждение",
        ),
        sa.Column("department", sa.String(), nullable=True, comment="Отделение"),
        sa.Column(
            "attending_doctor", sa.String(), nullable=True, comment="Лечащий врач"
        ),
        sa.Column(
            "doctor_contacts", sa.String(), nullable=True, comment="Контакты врача"
        ),
        sa.Column(
            "medical_procedure",
            sa.String(),
            nullable=True,
            comment="Медицинская процедура",
        ),
        sa.Column(
            "final_report_delivery",
            sa.Text(),
            nullable=True,
            comment="Финальный репорт отправить",
        ),
    ...
    op.create_index(
        op.f("ix_referrals_case_number"), "referrals", ["case_number"], unique=False
    )
    ...
    op.create_table(
        "clinic_patient_statuses",
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column("patient_id", sa.String(length=36), nullable=False),
        sa.Column(
            "patient_status_for_clinic",
            sa.Enum(
                "registered",
                "diagnosed",
                "under_treatment",
    ...
    op.create_index(
        op.f("ix_referral_attachments_id"), "referral_attachments", ["id"], unique=False
    )
    op.create_table(
        "glasses",
        sa.Column("id", sa.String(length=36), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_cor_id_auth_sessions_session_token"), table_name="cor_id_auth_sessions"
    )
    op.drop_index(
        op.f("ix_cor_id_auth_sessions_email"), table_name="cor_id_auth_sessions"
    )
    op.drop_index(
        op.f("ix_cor_id_auth_sessions_cor_id"), table_name="cor_id_auth_sessions"
    )
